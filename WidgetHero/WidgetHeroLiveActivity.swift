...
struct WidgetHeroLiveActivity_Previews: PreviewProvider {
    static let attributes = WidgetHeroAttributes(name: "Me")
    static let contentState = WidgetHeroAttributes.ContentState(value: 3)
